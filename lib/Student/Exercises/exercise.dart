...
import 'exercise_play_widgets.dart';
import 'exercise_result.dart';

class ExerciseAttempt extends StatefulWidget {
  final String quizId;
  final String title;
  ExerciseAttempt(this.quizId, this.title);

  @override
  _ExerciseAttemptState createState() => _ExerciseAttemptState();
}
...
class _ExerciseAttemptState extends State<ExerciseAttempt> {
        ...
        onPressed: () {
          if (_notAttempted != 0) {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => ExerciseResults(
                      correct: _correct,
